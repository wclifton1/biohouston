		...
		<tr id="eb-tec-payment-options" class="EBForm eb-tec-payment-options">
			...
			<td>
				<div id="eb-tec-payment-options-checkboxes">
					<div class='label'><strong><?php _e( 'Online', 'tribe-eventbrite' ); ?></strong></div>
               <div class='online'>
               		<?php
               		/*
               ...
               <div class='label tec-eb-offline-pay-options'><strong><?php _e( 'Offline', 'tribe-eventbrite' ); ?></strong></div>
