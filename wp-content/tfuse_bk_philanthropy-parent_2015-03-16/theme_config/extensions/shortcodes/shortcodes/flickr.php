...
function tfuse_flickr($atts, $content)
{
    ...
    return '<div class="widget widget_flickr clearfix">' . $title . '<script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?count=' . $items . '&amp;display=random&amp;size=s&amp;layout=x&amp;source=user&amp;user=' . $flickr_id . '"></script></div><br class="clear"/>';
}
